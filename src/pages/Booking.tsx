                  ...
                  <div className="lg:col-span-8 space-y-7">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full h-12 rounded-xl border px-4 text-sm font-semibold focus:outline-none focus:ring-2 transition-all ${
                          isDateInPast
                            ? 'bg-rose-50 border-rose-400 text-rose-500 focus:ring-rose-300'
                            : 'bg-brand-bg-soft border-brand-border text-brand-ink focus:ring-brand-primary/25'
                        }`}
                        value={formData.date}
                        onChange={(e) => setFormData({ ...formData, date: e.target.value })}
                      />
                      {isDateInPast && (
                        <p className="mt-1.5 text-xs text-rose-500 font-medium">Cannot book an appointment for a past date.</p>
                      )}
                    </div>
